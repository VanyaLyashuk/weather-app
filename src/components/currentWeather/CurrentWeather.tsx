...
const CurrentWeather: React.FC = () => {
  ...
  return (
    <section className="px-3 py-6 mb-6 rounded-md shadow-md sm:px-4 sm:py-6 sm:flex sm:flex-wrap md:px-[18px] md:py-8 sm:mb-7 bg-white dark:bg-slate-800">
      ...
      <h1 className="w-full text-3xl leading-none font-bold break-words mt-2 sm:mt-2 sm:text-[32px] md:text-4xl dark:text-slate-400">
        {locationName}
      </h1>
      ...
      <p className="mb-4 text-lg font-medium sm:text-xl sm:mb-0 md:text-2xl sm:order-last sm:w-full dark:text-slate-400 current-weather-description-xs">
        Feels like {feelsLike}°C. {description}
      </p>
      <ul className="border-l-[3px] border-primary pl-3 py-1 flex items-center gap-x-3 gap-y-2 flex-wrap text-base current-weather-condition-xs sm:pl-4 sm:w-[calc(100%_-_200px)] sm:self-center md:text-xl md:pl-8 md:gap-x-4 md:w-[calc(100%_-_245px)] dark:text-slate-400">
